    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="post" action="<?= base_url() ?>transaksi/update">
                ...
                <div class="form-group">
                    <input type="text" id="harga" class="form-control" value="<?= $transaksi['harga_paket']; ?>" placeholder="Harga" readonly>
                </div>
                ...
                <div class="form-group">
                    <input type="number" class="form-control" name="grand_total" id="grand_total" value="<?= $transaksi['grand_total']; ?>" placeholder="Grand Total" readonly>
                </div>
                ...
                <div class="form-group">
                    <input type="hidden" name="status" value="Baru" class="form-control" placeholder="Status">
                </div>
